 ...
 */
public class XmlBeanDefinitionReaderV4 {
    ...
    public XmlBeanDefinitionReaderV4(BeanDefinitionRegistryV3 register) {
    ...
    public void loadBeanDefinition(Resource resource) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                BeanDefinitionV3 beanDefinition = new GenericBeanDefinitionV3(id,beanClassName);
     ...
     */
    private void parsePropertyElement(Element beanElem, BeanDefinitionV3 beanDefinition) {
     ...
     * @return Object
     */
    private Object parsePropertyValue(Element ele, BeanDefinitionV3 beanDefinition, String propertyName) {
