...
public abstract class AbstractApplicationContextV5 implements ApplicationContextV2 {

    private DefaultBeanFactoryV5 factory;

    private ClassLoader beanClassLoader;

    protected AbstractApplicationContextV5(String configFile) {
        this(configFile, ClassUtils.getDefaultClassLoader());
    }

    protected AbstractApplicationContextV5(String configFile,ClassLoader classLoader) {
