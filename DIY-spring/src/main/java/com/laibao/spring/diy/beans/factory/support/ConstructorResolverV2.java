 ...
 */
public class ConstructorResolverV2 {
    ...
    public ConstructorResolverV2(ConfigurableFactoryV1 beanFactory) {
     ...
     * @return Object
     */
    public Object autowireConstructor(final BeanDefinitionV5 beanDefinition) {
